...
extern GUICTRL_DLL_API const UINT RANGE_CHANGED;
/*
...
class GUICTRL_DLL_API CRangeSlider : public CWnd
{
// Construction
public:
	CRangeSlider();
...
// Attributes
public:
	void SetBitmapChannel(UINT nNormal, UINT nActive);
...
protected:
	...
	CBitmap m_bmpThumbN;
	CBitmap m_bmpThumbS;
	CBrush m_brushChannelN;
	CBrush m_brushChannelS;
