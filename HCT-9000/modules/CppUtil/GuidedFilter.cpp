...
class CppUtil::GuidedFilterImpl
{
public:
...
class GuidedFilterMono : public CppUtil::GuidedFilterImpl
{
public:
...
class GuidedFilterColor : public CppUtil::GuidedFilterImpl
{
public:
...
cv::Mat CppUtil::guidedFilter(const cv::Mat &I, const cv::Mat &p, int r, double eps, int depth)
{
	return GuidedFilter(I, r, eps).filter(p, depth);
}


cv::Mat CPPUTIL_DLL_API CppUtil::guidedFilter(const cv::Mat & I, int r, double eps, int depth)
{
	cv::Mat p = I;
	return GuidedFilter(I, r, eps).filter(p, depth);
}
